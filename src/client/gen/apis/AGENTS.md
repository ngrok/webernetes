...
When using the local installed package for reference, prefer:

- `node_modules/@kubernetes/client-node/dist/gen/types/ObjectParamAPI.d.ts` for
  object-param request interfaces and method names.
- `node_modules/@kubernetes/client-node/dist/gen/apis/*.d.ts` for generated API
  class methods and return types.
